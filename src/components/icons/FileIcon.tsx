...
const FileIcon: FC<Props> = ({ style, className }) => (
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    className={className}
  >
    <path d="M47 56.5H13C11.067 56.5 9.5 54.933 9.5 53V8.00006C9.5 6.06706 11.067
     4.50006 13 4.50006H37.7929L50.5 17.2071V53C50.5 54.933 48.933 56.5 47 56.5Z" stroke="#BABDBF" />
